...
const pullRequestFields = 'baseRefName,body,comments,headRefName,headRefOid,headRepository,isDraft,mergeStateStatus,number,reviewDecision,reviews,state,statusCheckRollup,title,updatedAt,url'
export default defineSchedule({
  ...
  async handler(schedule) {
    ...
    const jobs = await selectPullRequestJobs(repositories, listPullRequests, readCompletion, policyFingerprint)
