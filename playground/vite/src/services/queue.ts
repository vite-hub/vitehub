...
export function registerQueueRoutes(app: { get: (route: string, handler: ReturnType<typeof defineEventHandler>) => unknown, delete: (route: string, handler: ReturnType<typeof defineEventHandler>) => unknown, post: (route: string, handler: ReturnType<typeof defineEventHandler>) => unknown }) {
