...
describe("vitehub", () => {
  ...
  it("resolves public ViteHub imports through the facade", async () => {
    ...
    await expect(resolveId.call(context, "@vite-hub/workspace/hosted", "/app/.vitehub/agent/chat-webhook-route.ts")).resolves.toBe("resolved:@vite-hub/vite/workspace/hosted")
