...
function serializeCloudflareRuntime(config: ResolvedKVModuleOptions): string {
  return [
    ...
    "    async getAndDelete() { throw new Error(\"[vitehub] Cloudflare KV does not support atomic operations. Use Upstash or Deno KV.\"); },",
    ...
    "    async increment() { throw new Error(\"[vitehub] Cloudflare KV does not support atomic operations. Use Upstash or Deno KV.\"); },",
