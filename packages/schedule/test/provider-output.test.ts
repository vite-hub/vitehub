...
describe("schedule provider output", () => {
  ...
  it("resolves the runtime execute entry from package source and dist layouts", () => {
    ...
    expect(resolveScheduleRuntimeEntry("file:///repo/packages/schedule/dist/vite.js")).toBe("/repo/packages/schedule/dist/runtime/execute.js")
    expect(resolveScheduleRuntimeEntry("file:///repo/packages/schedule/nitro.js")).toBe("/repo/packages/schedule/dist/runtime/execute.js")
