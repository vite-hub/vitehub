...
function generatedWorkspaceSourceRootHelper(name: string, workspaceDefinitionFromOptions: string, typescript = false): string[] {
  ...
  return [
    ...
    "    Object.defineProperty(agent, Symbol.for('vitehub.agent.colocatedSkills'), descriptor)",
    "    if (resolvedAgent !== agent) Object.defineProperty(resolvedAgent, Symbol.for('vitehub.agent.colocatedSkills'), descriptor)",
    "  }",
