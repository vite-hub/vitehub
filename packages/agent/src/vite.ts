...
async function generateAgentWebhookRouteHandler(
  ...
  return [
    ...
    `import { getWorkspaceHostedStoreLoader, setWorkspaceHostedStoreLoader, setWorkspaceRuntimeRegistry } from ${JSON.stringify(subpath(workspaceImportBase, "runtime"))}`,
    `import { createGitHubWorkspaceStore } from ${JSON.stringify(subpath(workspaceImportBase, "internal/stores/github"))}`,
