...
>(
  ...
  const { createWorkflow } = await import(/* @vite-ignore */ workflowSpecifier)
  const { getInlineWorkflowDefinitions } = await import(/* @vite-ignore */ workflowRuntimeStateSpecifier)
...
>(
  ...
  const { runWithWorkflowRuntimeEvent } = await import(/* @vite-ignore */ workflowRuntimeStateSpecifier)
