...
describe("framework package contract", () => {
  ...
  it("ships every declared export and both CLI names", () => {
    ...
    expect(consolePage).toContain('name: "vitehub-console-invocation"')
    ...
    expect(readFileSync(`${packageRoot}/dist/console/runtime/pages/agents.vue`, "utf8"))
      .toContain("<ClientOnly>")
    expect(readFileSync(`${packageRoot}/dist/console/runtime/client/app.vue`, "utf8"))
      .toContain('<UApp :toaster="null">')
