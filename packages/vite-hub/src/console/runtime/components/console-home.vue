    ...
    >
      ...
      <template #default="{ collapsed }">
        ...
        <p v-else-if="!collapsed && !error" class="px-4 text-sm leading-6 text-muted">
          Enable Agents, Blob, KV, Workflow, Queue, or Schedule in the ViteHub configuration to add a section.
        </p>
      </template>
        ...
        <main class="min-h-0 flex-1 overflow-y-auto px-5 py-8 sm:px-8 sm:py-10 lg:px-12">
          <div class="mx-auto w-full max-w-5xl">
            ...
            <UEmpty
              ...
              description="Enable Agents, Blob, KV, Workflow, Queue, or Schedule in the ViteHub configuration to add a Console page."
            />
          </div>
        </main>
      </div>
