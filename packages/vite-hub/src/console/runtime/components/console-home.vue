...
const props = defineProps<{ sectionsBase: string }>();
    ...
    >
      ...
      <template #default="{ collapsed }">
        ...
        <p v-else-if="!collapsed && !error" class="px-4 text-sm leading-6 text-muted">
          Enable Agents or KV in the ViteHub configuration to add a section.
        </p>
      </template>
    ...
    <UDashboardPanel id="console-home">
      <div class="flex min-h-0 flex-1 flex-col">
        ...
        <UEmpty
          ...
          description="The sidebar contains the ViteHub sections enabled for this project."
        />
      </div>
    </UDashboardPanel>
  </ConsoleFrame>
