...
export function resolveConsoleRouteName(currentRouteName: string | symbol | null | undefined, targetRouteName: string): string {
  ...
  const consoleRouteName = ["vitehub-console-invocation", "vitehub-console-workflows", "vitehub-console-agents", "vitehub-console-agent", "vitehub-console-usage", "vitehub-console-kv", "vitehub-console"].find(
