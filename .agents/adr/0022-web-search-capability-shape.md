...
- A separate `@vitehub/agent/web` public entrypoint was rejected for the first version because recent capability work keeps factories discoverable through `@vitehub/agent/capabilities` while moving implementation into feature-owned internal modules.
