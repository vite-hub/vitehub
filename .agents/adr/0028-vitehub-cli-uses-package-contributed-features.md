...
- Host-adapter-driven CLI registration was rejected as the primary model because framework/runtime wiring should not own command assembly or public command behavior.
