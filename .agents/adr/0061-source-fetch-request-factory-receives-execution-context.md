...
Superseded note: ADR 0075 retracts Source Instructions from Source configuration. The request factory constraints remain current; execution context still cannot define model-facing instruction coverage.
