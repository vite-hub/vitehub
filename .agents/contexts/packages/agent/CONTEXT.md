...
- Routing non-chat provider webhooks through Chat Platform Adapter abstractions was considered - resolved: **Agent Webhook Routes** dispatch non-chat Channel triggers directly, while chat adapter behavior stays in the **Chat Webhook Handler** branch.
