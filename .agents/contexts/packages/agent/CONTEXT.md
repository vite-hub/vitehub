...
- "Nuxt UI adapter" was considered for application chat UIs - resolved: application chat UIs are app-owned trigger consumers, while Chat Platform Adapters remain for external chat platforms.
