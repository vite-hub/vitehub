...
- The **Agent Package** does not copy Flue-style root `tools`, `skills`, or `sandbox` fields; harness sandbox setup stays Agent Package runtime plumbing behind the **Agent Harness Driver Contract**, and tools or Skills stay Capability-owned.
