...
- [Framework Integrations](./contexts/framework-integrations/CONTEXT.md) - names Vite-first discovery, runtime registry, server host adapters, and option lifecycle boundaries.
...
- **Framework Integrations -> DevTools**: Vite integrations and server host adapters register DevTools features and bridges for the hosted DevTools client.
