...
| Email      | Resend           | Cloudflare Email      | Resend                | Resend               | Resend         | Host driver    | Resend or custom      |
