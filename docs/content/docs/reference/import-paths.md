...
| `vite-hub/browser/actions` | Cloudflare Browser Run quick actions without opening a Playwright session. |
...
| `@vite-hub/browser/actions` | Browser Package | Cloudflare Browser Run quick actions without opening a Playwright session. |
