...
| `vite-hub/channels` and `vite-hub/channels/server` | Outbound clients for global Agent Channels. |
...
| `@vite-hub/channels` | Channels Package | Global Agent Channel clients, explicit clients, and normalized delivery results. |
