...
Consult [CONTRIBUTING.md](CONTRIBUTING.md) for setup, focused checks, design, UI, and PR guidance that applies to the task. Use the issue, PR, or consumer cited by the task when it provides context. State the user-visible result and adjacent behavior to preserve.
